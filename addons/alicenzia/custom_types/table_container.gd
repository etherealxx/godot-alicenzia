...
## Manual Update
@export_tool_button("Update Table", "Loop") var manual_update = refresh

@export_custom(PROPERTY_HINT_NONE, "suffix:px") var minimum_cell_length : float = _checkable_properties[&"minimum_cell_length"]
